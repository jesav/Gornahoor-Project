...
\end{itemize}
This is a positive task and should be a thing of beauty, suitable for men with a sense of \emph{noblesse oblige}. If we seem negative, that is because of the necessary task of outing those who claim to be on the side of Tradition, but who, in reality, form a counter-tradition, which is revealed through the ugliness of their discourse, their unaesthetic music, and their rejection of a spiritual Solidarity in the present and Continuity with the past. To be considered a man, they misunderstand the true Pagan as a creature given over to his liberated \emph{elan vital}, and ``might is right'' philosophy. Thus, they demonstrate their lack of understanding of the counter balancing \emph{frein vital}, the Buddhist ``battle in the cave of dragons'', or the man able to dominate and control his unbridled passions.
...
\begin{footnotesize}
\begin{sffamily}
\texttt{logres on 2011-07-26 at 16:55 said:}

\url{http://unqualified-reservations.blogspot.com/2011/07/indisputable-humanity-of-anders-behring.html}

Interesting analysis from a self-described Jacobite. Might be worth talking to.

\hfill

\texttt{Matt on 2011-07-26 at 19:53 said:}

When you have felt that the necessary time to breath has passed, by all means, post your analysis on the Norwegian case.
