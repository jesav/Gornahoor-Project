...
\begin{itemize}
\item\textit{The State of Mental Health in America:} \url{https://www.mhanational.org/issues/state-mental-health-america}

\item\textit{National Institute of Mental Health:} \url{https://www.nimh.nih.gov/health/statistics/mental-illness.shtml}

\item\textit{Personality Disorders:} \url{https://www.mayoclinic.org/diseases-conditions/personality-disorders/symptoms-causes/syc-20354463}
\end{itemize}
...
\texttt{Cologero on 2021-01-22 at 12:52 said: }

Savant, please read the article very carefully and try again. However, I must accept responsibility for not being clear enough. This is not a description of a human designed organization, but how God would see it. Perhaps that sounds arrogant, but God has revealed His plan. Perhaps this might supplement the post: \textit{Liberating the Guardian Angel}\footnote{\url{https://www.meditationsonthetarot.com/liberating-the-guardian-angel}}.

On the other hand, I think that the post makes one thing clear. Few people understand their purpose and destiny in life. But those who do, need to act on it. Otherwise there would be no Saints that you referred to.

Also, please refrain from gratuitous comments that may sound funny to you, but are inappropriate in today's intellectual climate.
