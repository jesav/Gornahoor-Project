\section{Liberalism and Socialism}

\label{sec:LiberalismSocialism}
...
Liberalism & Political institutions \\ Socialism & Social institutions \\ Tradition & Man himself \\\bottomrule
\end{tabular}
\end{table}
