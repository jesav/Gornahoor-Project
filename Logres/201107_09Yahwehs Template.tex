...
This is probably central to demoralizing or de-sentimentalizing the Church. In any case, the Gnostic emphasis was correct (flesh has to be transcended) while their understanding of Torah is wrong. In the Cephas debate, one senses that Cephas is dealing with someone who is getting steps out of order. If the Church had lost (or was unable to maintain or to teach) the proper steps as outlined in the Beatitude (combined with esoteric initiations), then the Gnostic misunderstanding and tragedy makes perfect sense. Further research into early Christianity \& the Greek or Russian connections may reveal more interesting facts and interpenetrations than we have endeavored to touch on here for now.\footnote{For more on Clement\footnote{\url{http://jacksonsnyder.com/arc/bible-news/apostolia/index.htm}}}

Who is Yahweh? Jesus certainly never spoke of Him, except to say that ``before Abraham was, I am''. Jesus taught of His Father; and yet he kept the rites of Yahweh in such a way as to transform them. The more he taught, the angrier the Law-protectors of Yahweh became. Yet Jesus affirms that ``not one jot or tittle shall pass from the Law, till all is fulfilled''. There is certainly something odd about Jesus \& Yahweh, as well as their relationship.

Russian theology can be viewed as a very complex \& concrete struggle over precisely these issues -- the Orthodox Church is both ``more Jewish'' and ``more New Testament'' than every other Church. One might go so far as to claim that only in Russia has there been additional ``life'' in revelation (as a generalization) -- the Catholic Church early on decided in favor of ``dogma'' and ``reason'' in peculiarly Western forms, which nevertheless had their ``Russian moments'' of inspiration and mysticism. Gornahoor has drawn attention to Russia repeatedly; it is not the only one\footnote{\url{http://www.metahistory.org/GRAIL/AlternativeGrail.php}} to remark so:
...
Bondarev \& Steiner\footnote{\url{http://www.altanthroinfo.9f.com/GoodEvil.htm}} also argued that the Slavic and Teutonic worlds were the locus of human spiritual evolution, and therefore subjected to vicious reprisals from the opposing elements or ``powers''. Gornahoor actually posits that de Maistre\footnote{\url{http://en.wikipedia.org/wiki/Joseph\_de\_Maistre}} represented a European connection with ``secret doctrine'' in Russia. All of the authors mentioned above (Fedarov, etc.) were the subjects of essays by Berdyaev that are on the Web\footnote{\url{http://www.berdyaev.com/}}.
...
Not all of the debate has occured ``outside'' the communion -- Bulgakov's\footnote{\url{http://en.wikipedia.org/wiki/Sergei\_Bulgakov}} theology of Sophia is interesting in this regard. Slavic civilization \& religion has been willing to entertain energetic and dynamic views of both Yahweh
\& the archangel Michael.


The Gnostic debate over Yahweh's real identity (ignorance or evil?) and equation with the Demiurge represented a dead end -- it was the ``dogmatizing'' or externalizing (theologians would say ``reifying'') of a false dilemma. Instead, Yahweh can be viewed as the Slavic nation(s) have chosen to do so -- as an aspect of the Divine which is not conceived of legalistically or juridically as a kind of ``final'' name for God, but rather as a countenance given by God to man at a particular point of his development.

It is not enough for a Westerner to discuss ``Law'' vs. ``Grace''; this guts the debate of metaphysics and Being and ``reifies'' in precisely the manner which lead to Gnostic misunderstandings and burst the early Church into an esoteric core and exoteric skeleton, both of which were endangered without the other.

Steiner argues\footnote{\url{http://www.doyletics.com/arj/turningp.htm}} that the Pharisees could not identify Christ by his face, because all of the apostles were transformed into his countenance during their preaching. This was why Judas had to betray with a kiss. Steiner also makes some observations which should interest anyone who has read Gurdjieff:
...
One might suggest that the astral body (to which Gurdjieff gave such attention in efforts to ``form'' or crystallize it, to which event we attach the name ``initiation'') was the point of contact between the earthly Soul \& the heavenly Spirit, whose focal point was the midpoint between the fair body of Earth and the angel standing in the middle of the Sun -- Sin, Lune, the Moon. Thus, the ``overcoming'' of the Moon was synonymous with overcoming Sin. Yet the Moon was indispensable, because without the crystallization of the astral body in a ``seed'', no progress beyond the Moon could occur. For those without the Law, there was no Sin in the Law. For those without a conscience, there was nothing but the animal kingdom and the law of tooth and claw. Consciousness of sin (or formation of an astral body) was what enabled the ``leaping over the moon'' -- breaking free -- the marriage of the Soul and the Spirit. This, of course, is precisely what Mouravieff teaches in \emph{Gnosis}, and which he claimed is a verbal tradition in Orthodoxy.

Romanity (as we refan its flames) could benefit from the secret fire passed on through Alexandria and kept safe in Russia.
