...
He showed them a Being, adorned with a myriad of glittering lights of various colors, who sat on a throne, a crown on her head, rings in her ears, a drawn sword by her side. The radiance streaming forth from her illumined the whole garden. When the first humans asked, ``Who is this?'', the following answer was given to them: ``This is the form of Fatima Zahra, as she appears in Paradise. Her crown is Muhammad, her earrings are Hassan and Hussayn, and her sword is `Ali (Ibn Abi Talib).
\flright{\textsc{Louis Massignon}, Eranos Jahrbuch, \emph{Die Urspringe und die Bedeutung des Gnostizismus im Islam} (Zurich, 1938), pp. 64-65. Cited in \emph{Horse of Karbala} by David Pinault, op. cit., p. 65.}
\end{quotationx}
